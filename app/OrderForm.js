...
const OrderForm = () => {
  ...
  return (
    <Card className='max-w-xl mx-auto my-8'>
      ...
      >
        <Title level={3}>{new Date().getFullYear() + 1}年 Sheena熙蒳 桌曆預購表</Title>
        <Space direction='vertical' className='mb-2'>
          ...
          <Text>滿兩千免運 預購即日起-12/20 隨後出貨</Text>
        </Space>
        ...
        <div className={`flex gap-4 ${deliveryMethod === '711' ? '' : 'flex-wrap'}`}>
          <Form.Item
            ...
            name='storeId'
            label='711 配送門市'
            rules={[{ required: true, message: '請填寫門市' }]}
          >
